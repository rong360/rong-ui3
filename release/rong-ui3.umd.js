...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["rong-ui3"] = {}, global.Vue));
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    const _directive_preventscroll = vue.resolveDirective("preventscroll");
    return vue.openBlock(), vue.createBlock(vue.Transition, {
      ...
      default: vue.withCtx(() => [
        vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
          class: vue.normalizeClass(_ctx.bem()),
  ...
  const _sfc_main$1 = vue.defineComponent({
    ...
    components: { Overlay },
    setup(props, { emit }) {
      const showPopup = vue.ref(props.show);
      vue.watch(
        () => props.show,
        (newVal) => {
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(vue.Teleport, {
      ...
      _ctx.overlay ? (vue.openBlock(), vue.createBlock(_component_Overlay, {
        key: 0,
      ...
      }, null, 8, ["class", "custom-style", "close-on-click-overlay", "animate", "duration", "transition", "z-index", "onClick", "show"])) : vue.createCommentVNode("", true),
      vue.createVNode(vue.Transition, {
        ...
        default: vue.withCtx(() => [
          vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
            class: vue.normalizeClass([_ctx.bem({ round: _ctx.round, [_ctx.position]: true }), _ctx.popupClass]),
            style: vue.normalizeStyle(_ctx.style)
          }, [
            vue.renderSlot(_ctx.$slots, "default")
          ], 6)), [
            [_directive_preventscroll],
            [vue.vShow, _ctx.showPopup]
          ])
        ]),
        _: 3
  ...
  const __default__ = vue.defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const showDialog = vue.ref(props.show);
      vue.watch(
        () => props.show,
        (newValue) => {
  ...
  const $dialog = (options, components) => {
    ...
    const app = vue.createApp(_Dialog, options);
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass(_ctx.bem({ useFixed: _ctx.useFixed }))
    }, [
      vue.createElementVNode("header", {
        class: vue.normalizeClass(_ctx.bem("header"))
      }, [
        vue.renderSlot(_ctx.$slots, "header")
      ], 2),
      vue.createElementVNode("main", {
        class: vue.normalizeClass([_ctx.bem("main"), "scroll-area"]),
        ...
        _ctx.useFixed ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: vue.normalizeClass(_ctx.bem("headercopy"))
        }, [
          vue.renderSlot(_ctx.$slots, "header")
        ...
        _ctx.useFixed ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 1,
          class: vue.normalizeClass(_ctx.bem("footercopy"))
        }, [
          vue.renderSlot(_ctx.$slots, "footer")
        ], 2)) : vue.createCommentVNode("", true)
      ], 34),
      _ctx.showFooter ? (vue.openBlock(), vue.createElementBlock("footer", {
        key: 0,
        class: vue.normalizeClass(_ctx.bem("footer"))
      }, [
        vue.renderSlot(_ctx.$slots, "footer")
      ], 2)) : vue.createCommentVNode("", true)
    ], 2)), [
